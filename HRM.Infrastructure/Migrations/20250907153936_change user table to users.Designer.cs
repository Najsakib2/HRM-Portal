...
namespace HRM.Infrastructure.Migrations
{
    ...
    [Migration("20250907153936_change user table to users")]
    partial class changeusertabletousers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM.Domain.Authentication.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Domain.Company", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Domain.UserDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Domain.Users", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Domain.BankInformation", b =>
                {
                    b.HasOne("HRM.Domain.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRM.Domain.Users", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM.Domain.UserDetails", b =>
                {
                    ...
                    b.HasOne("HRM.Domain.Users", "User")
                        .WithOne("userDetails")
                        .HasForeignKey("HRM.Domain.UserDetails", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
